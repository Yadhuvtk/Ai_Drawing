...
def main() -> None:
    ...
    parser.add_argument("--preblur_radius", type=float, default=0.9, help="Blur radius applied before thresholding to stabilize anti-aliased edges.")
    ...
    parser.add_argument("--simplify_tolerance", type=float, default=0.8, help="Contour simplification tolerance.")
    ...
    parser.add_argument("--smooth_iterations", type=int, default=3, help="Corner-aware smoothing passes on curved spans.")
    parser.add_argument("--smooth_strength", type=float, default=0.42, help="How strongly curved spans are smoothed.")
    ...
    parser.add_argument("--primitive_fit_error_threshold", type=float, default=1.0, help="Maximum boundary error allowed for rectangle-like primitive fits.")
    parser.add_argument("--topology_area_tolerance", type=float, default=0.12, help="Maximum allowed relative area distortion before a fitted contour falls back.")
    parser.add_argument("--hole_area_tolerance", type=float, default=0.16, help="Maximum allowed relative area distortion for hole contours before fallback.")
    parser.add_argument("--topology_bbox_iou_threshold", type=float, default=0.68, help="Minimum bbox IoU required between fitted outer contours and source contours.")
    parser.add_argument("--hole_bbox_iou_threshold", type=float, default=0.56, help="Minimum bbox IoU required between fitted holes and source holes.")
    ...
    parser.add_argument("--quadratic_fit_tolerance", type=float, default=0.5, help="Max fit error for quadratic Bezier spans.")
    parser.add_argument("--bezier_fit_tolerance", type=float, default=2.0, help="Max fit error for cubic Bezier spans.")
    parser.add_argument("--circle_fit_tolerance", type=float, default=0.055, help="Tolerance for promoting a contour to a circle.")
    parser.add_argument("--circle_circularity_min", type=float, default=0.84, help="Minimum circularity required before exporting a real circle.")
    parser.add_argument("--circle_confidence_threshold", type=float, default=0.9, help="Minimum confidence required before promoting a contour to a circle.")
    parser.add_argument("--ellipse_fit_tolerance", type=float, default=0.085, help="Tolerance for promoting a contour to an ellipse.")
    parser.add_argument("--ellipse_confidence_threshold", type=float, default=0.88, help="Minimum confidence required before promoting a contour to an ellipse.")
    parser.add_argument("--rectangle_confidence_threshold", type=float, default=0.92, help="Minimum confidence required before promoting a contour to a rectangle.")
    parser.add_argument("--rounded_rectangle_confidence_threshold", type=float, default=0.9, help="Minimum confidence required before promoting a contour to a rounded rectangle.")
